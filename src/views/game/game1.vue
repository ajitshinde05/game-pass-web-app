<template>
  <div class="hp-100">
    <div class="cont-padding">
      <b-row class="tab-f-h-bg">
        <b-col md="6" class="pr-0 no-pd-lf">
          <div class="tab-f-h">
            <div class="main-page">
              <div class="abs">
                <!-- <Animated/> -->
                <div class="slot-game">
                  <div class="machine">
                    <div class="slots">
                      <ul v-for="j in 3" :key="j" class="slot" :style="{ left: slotLeft(j) }">
                        <li v-for="i in 10" :key="i" class="number" :style="{ transform: numberTransform(i) }">
                    ...
                    <b-row class="ml-0 mr-0">
                      <b-col>
                        <b-row class="justify-content-between mb-1">
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(0)" @click.prevent="
                                  playSound(
                                  ...
                                  " src="../../assets/Group-0.svg" class="pricing-img" alt="basic svg img" />
                              </b-col>

                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-badge class="badge-cust" variant="light-success">
                                  {{
                                    gameNumbers['0']
                                    ? ` $ ${gameNumbers['0']}`
                                    : '-'
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(1)" @click.prevent="
                                  playSound(
                                    'https://www.zapsplat.com/wp-content/uploads/2015/sound-effects-77317/zapsplat_multimedia_button_click_fast_short_004_79288.mp3',
                                  )
                                  " src="../../assets/Group-1.svg" class="pricing-img" alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(2)" @click.prevent="
                                  playSound(
                                    'https://www.zapsplat.com/wp-content/uploads/2015/sound-effects-77317/zapsplat_multimedia_button_click_fast_short_004_79288.mp3',
                                  )
                                  " src="../../assets/Group-2.svg" class="pricing-img" alt="basic svg img" />
                              </b-col>
                            </b-row>
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(3)" src="../../assets/Group-3.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(4)" @click.prevent="
                                  playSound(
                                    'https://www.zapsplat.com/wp-content/uploads/2015/sound-effects-77317/zapsplat_multimedia_button_click_fast_short_004_79288.mp3',
                                  )
                                  " src="../../assets/Group-4.svg" class="pricing-img" alt="basic svg img" />
                              </b-col>
                        ...
                        <b-row class="justify-content-between">
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(5)" src="../../assets/Group-5.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(6)" src="../../assets/Group-6.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(7)" src="../../assets/Group-7.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(8)" src="../../assets/Group-8.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
                          ...
                          <b-col cols="2" sm="2">
                            <b-row>
                              <b-col cols="12" sm="12" class="d-flex justify-content-center">
                                <b-img @click="addAmount(9)" src="../../assets/Group-9.svg" class="pricing-img"
                                  alt="basic svg img" />
                              </b-col>
        ...
        <b-col md="6" class="mt-2 mb-1 pl-0 pr-0 pd-r-l">
            ...
            <b-row>
              <b-col>
                <b-table class="position-relative no-headers userlist-table child-1-30-percent" responsive show-empty
                  align-v="end" :items="items" :fields="tableColumns">
                  <!-- Column: User -->
          ...
          <b-card class="mt-1 table-card-p last-table">
            <b-row>
              <b-col>
                <b-table class="position-relative no-headers userlist-table child-1-30-percent" responsive show-empty
                  align-v="end" :items="users" :fields="userTableColumns">
                  <template #cell(user)="row">
                    <b-media class="align-item-center">
                      <template #aside>
                        <b-avatar size="30" src="RA" text="PN" />
      ...
      <b-modal id="modal-sm-no-account" no-close-on-esc :hide-footer="true" no-close-on-backdrop centered
        modal-class="no-header-modal">
        <b-form-input v-model="amount" type="number" name="login-email" placeholder="amount" />
