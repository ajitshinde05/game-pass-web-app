    ...
    <section class="main-w-r p-2">
      ...
      <b-row class="d-flex justify-content-center align-items-center">
        <b-col md="12" lg="6" sm="12" class="">
          <b-img src="../../assets/home.svg" @click="redirectOnGame(4)" alt="basic svg img" class="w-100" />
        </b-col>
      </b-row>
      <div>
        ...
        <b-row class="justify-content-center align-items-center">
          <b-col sm="6" lg="3" class="col-w-r">
            <b-card class="min-card">
              <b-img src="../../assets/home-1.svg" @click="redirectOnGame(1)" @click.prevent="
                playSound(
          ...
          <b-col sm="6" lg="3" class="col-w-r">
            <b-card class="min-card">
              <b-img src="../../assets/home-2.svg" @click="redirectOnGame(2)" alt="basic svg img" />
          ...
          <b-col sm="6" lg="3" class="col-w-r">
            <b-card class="min-card">
              <b-img src="../../assets/home-3.svg" @click="redirectOnGame(3)" alt="basic svg img" />
          ...
          <b-col sm="6" lg="3" class="col-w-r">
            <b-card class="min-card">
              <b-img src="../../assets/home-4.svg" class="pricing-img" @click="redirectOnGame(4)" alt="basic svg img" />
