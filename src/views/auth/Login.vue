        ...
        <b-col sm="8" md="6" lg="12" class="px-xl-2 mx-auto">
          ...
          <validation-observer ref="loginValidation">
            <b-form class="auth-login-form mt-2" @submit.prevent>
              <!-- email -->
              <b-form-group class="font-weight-bold" label="Enter Mobile Number" label-for="mobile-number">
                <validation-provider #default="{ errors }" name="Mobile Number" rules="required|regex:^[0-9]{10}$">
                  <b-form-input type="number" id="mobile-number" v-model="mobileNumber"
                    :state="errors.length > 0 ? false : null" name="mobile-number" placeholder="Enter Mobile Number" />
              ...
              <b-button type="submit" variant="primary" block :disabled="isLoading" @click="validationForm">
                {{ $t('Login.LoginBtn') }}
              </b-button>
            </b-form>
          </validation-observer>
