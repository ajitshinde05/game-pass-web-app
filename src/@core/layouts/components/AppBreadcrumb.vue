<template>
  ...
  >
    <!-- Content Left -->
    <b-col class="content-header-left mb-2 header-margin-top" cols="12" md="9">
      <b-row class="breadcrumbs-top">
        <b-col cols="12">
          <h2 class="content-header-title float-left pr-1 mb-0">
            {{ $t(`BreadcrumbLabels.Titles.${$route.meta.pageTitle}`) }}
          </h2>
          <div class="breadcrumb-wrapper">
            <b-breadcrumb>
              <b-breadcrumb-item :to="{ name: 'home', params: { lang: lang } }">
                <feather-icon
                  icon="HomeIcon"
                  size="16"
              ...
              <b-breadcrumb-item
                ...
                :to="item.to"
              >
                {{ $t(`BreadcrumbLabels.PathLabels.${item.text}`) }}
              </b-breadcrumb-item>
            </b-breadcrumb>
          </div>
        </b-col>
